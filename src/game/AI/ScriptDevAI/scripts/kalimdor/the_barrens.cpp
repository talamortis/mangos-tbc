...
class npc_wizzlecranks_shredder : public CreatureScript
{
public:
...
class npc_gallywix : public CreatureScript
{
public:
    npc_gallywix() : CreatureScript("npc_gallywix") { }
...
class npc_venture_co_lookout : public CreatureScript
{
public:
    npc_venture_co_lookout() : CreatureScript("npc_venture_co_lookout") { }
...
class npc_foreman_silixiz : public CreatureScript
{
public:
    npc_foreman_silixiz() : CreatureScript("npc_foreman_silixiz") { }
...
public:
    ...
    private:
        ...
        bool SpawnCreature(SpawnPointVector const& spawnPoints, SpawnPointIndexMap& creatureSlotMap, FullGuidList& killedGuidList, uint32 entry1, uint32 entry2, int32 moveToWP = -1)
        {
            ...
            {
                error_log("SD2::SpawnCreature> Invalid GUID was present in guidList container!");
...
void AddSC_the_barrens()
{
    ...
    new npc_wizzlecranks_shredder();
    new npc_gallywix();
    new npc_foreman_silixiz();
    new npc_venture_co_lookout();
