...
public:
    ...
    {
        return new instance_arcatrazAI(pMap);
    }

    struct instance_arcatrazAI : public ScriptedInstance, private DialogueHelper
    {
        instance_arcatrazAI(Map* pMap) : ScriptedInstance(pMap), DialogueHelper(aArcatrazDialogue),
