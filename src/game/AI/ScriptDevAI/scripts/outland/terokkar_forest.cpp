...
class npc_avatar_of_terokk : public CreatureScript
{
public:
    npc_avatar_of_terokk() : CreatureScript("npc_avatar_of_terokk") { }
...
class npc_minion_of_terokk : public CreatureScript
{
public:
    npc_minion_of_terokk() : CreatureScript("npc_minion_of_terokk") { }
...
void AddSC_terokkar_forest()
{
    ...
    new npc_avatar_of_terokk();
    new npc_minion_of_terokk();
    new npc_draenei_tomb_guardian();
    new npc_vengeful_harbinger();
