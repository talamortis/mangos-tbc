...
class mob_arugal_voidwalker : public CreatureScript
{
public:
...
class boss_arugal : public CreatureScript
{
public:
...
class npc_arugal : public CreatureScript
{
public:
...
class npc_deathstalker_vincent : public CreatureScript
{
public:
...
void AddSC_shadowfang_keep()
{
    ...
    new mob_arugal_voidwalker();
    new npc_arugal();
    new boss_arugal();
    new npc_deathstalker_vincent();
