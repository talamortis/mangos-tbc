...
class npc_wilda : public CreatureScript
{
public:
...
#####*/
class mob_shadowmoon_soulstealer : public CreatureScript
{
public:
    mob_shadowmoon_soulstealer() : CreatureScript("mob_shadowmoon_soulstealer") { }
...
class npc_domesticated_felboar : public CreatureScript
{
public:
...
class npc_veneratus_spawn_node : public CreatureScript
{
public:
...
class npc_disobedient_dragonmaw_peon : public CreatureScript
{
public:
    npc_disobedient_dragonmaw_peon() : CreatureScript("npc_disobedient_dragonmaw_peon") { }
...
class npc_dragonmaw_racer_muckjaw : public CreatureScript
{
public:
    npc_dragonmaw_racer_muckjaw() : CreatureScript("npc_dragonmaw_racer_muckjaw") { }
...
class npc_dragonmaw_racer_trope : public CreatureScript
{
public:
    npc_dragonmaw_racer_trope() : CreatureScript("npc_dragonmaw_racer_trope") { }
...
class npc_dragonmaw_racer_corlok : public CreatureScript
{
public:
    npc_dragonmaw_racer_corlok() : CreatureScript("npc_dragonmaw_racer_corlok") { }
...
class npc_dragonmaw_racer_ichman : public CreatureScript
{
public:
    npc_dragonmaw_racer_ichman() : CreatureScript("npc_dragonmaw_racer_ichman") { }
...
class npc_dragonmaw_racer_mulverick : public CreatureScript
{
public:
    npc_dragonmaw_racer_mulverick() : CreatureScript("npc_dragonmaw_racer_mulverick") { }
...
class npc_dragonmaw_racer_skyshatter : public CreatureScript
{
public:
    npc_dragonmaw_racer_skyshatter() : CreatureScript("npc_dragonmaw_racer_skyshatter") { }
...
class mob_bt_battle_fighter : public CreatureScript
{
public:
    mob_bt_battle_fighter() : CreatureScript("mob_bt_battle_fighter") { }
    ...
    struct mob_bt_battle_fighterAI : public ScriptedAI, public CombatActions
    {
        ...
        uint32 GetInitialActionTimer(const uint32 action) const
        {
            switch (m_creature->GetEntry())
            {
                ...
                default:
                    sLog.outDebug("Script error: GetInitialActionTimer()> Not valid npc entry!");
                    return 0;
            }
        }
        ...
        uint32 GetSubsequentActionTimer(const uint32 action) const
        {
            switch (m_creature->GetEntry())
            {
                ...
                default:
                    sLog.outDebug("Script error: GetSubsequentActionTimer()> Not valid npc entry!");
                    return 0;
            }
        }
...
void AddSC_shadowmoon_valley()
{
    ...
    new mob_shadowmoon_soulstealer();
    new event_spell_soul_captured_credit();
    new go_crystal_prison();
    new npc_spawned_oronok_tornheart();
    new npc_domesticated_felboar();
    new npc_shadowmoon_tuber_node();
    new npc_veneratus_spawn_node();
    new npc_disobedient_dragonmaw_peon();
    new npc_commander_hobb();
    new npc_commander_arcus();
    new npc_dragonmaw_racer_muckjaw();
    new npc_dragonmaw_racer_trope();
    new npc_dragonmaw_racer_corlok();
    new npc_dragonmaw_racer_ichman();
    new npc_dragonmaw_racer_mulverick();
    new npc_dragonmaw_racer_skyshatter();
    new mob_bt_battle_fighter();
    new npc_bt_battle_sensor();
