...
public:
    ...
    struct instance_temple_of_ahnqirajAI : public ScriptedInstance, private DialogueHelper
    {
        instance_temple_of_ahnqirajAI(Map* pMap) : ScriptedInstance(pMap), DialogueHelper(aIntroDialogue),
...
public:
    ...
    bool OnTrigger(Player* player, AreaTriggerEntry const* at) override
    {
        if (at->id == AREATRIGGER_TWIN_EMPERORS || at->id == AREATRIGGER_SARTURA)
        {
            ...
            if (instance_temple_of_ahnqiraj::instance_temple_of_ahnqirajAI* pInstance = (instance_temple_of_ahnqiraj::instance_temple_of_ahnqirajAI*)player->GetInstanceData())
