...
class npc_taelan_fordring : public CreatureScript
{
public:
    ...
    bool OnQuestReward(Player* player, Creature* creature, const Quest* quest) override
    {
...
## npc_isillien
######*/
class npc_isillien : public CreatureScript
{
public:
