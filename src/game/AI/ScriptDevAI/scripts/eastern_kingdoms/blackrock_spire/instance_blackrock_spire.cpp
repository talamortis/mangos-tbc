...
public:
    ...
    {
        return new instance_blackrock_spireAI(pMap);
    }

    struct instance_blackrock_spireAI : public ScriptedInstance, private DialogueHelper
    {
        instance_blackrock_spireAI(Map* pMap) : ScriptedInstance(pMap), DialogueHelper(aStadiumDialogue),
        ...
        void OnCreatureDespawn(Creature* pCreature)
        {
        ...
        void DoUseEmberseerRunes(bool bReset)
        {
    ...
    bool OnTrigger(Player* pPlayer, AreaTriggerEntry const* pAt) override
    {
        ...
        switch (pAt->id)
        {
            case AREATRIGGER_ENTER_UBRS:
                if (instance_blackrock_spire::instance_blackrock_spireAI* pInstance = (instance_blackrock_spire::instance_blackrock_spireAI*) pPlayer->GetInstanceData())
                {
...
public:
    ...
    bool OnProcessEvent(uint32 /*uiEventId*/, Object* pSource, Object* /*pTarget*/, bool bIsStart) override
    {
        ...
        {
            if (instance_blackrock_spire::instance_blackrock_spireAI* pInstance = (instance_blackrock_spire::instance_blackrock_spireAI*)((Player*)pSource)->GetInstanceData())
            {
...
public:
    ...
    {
        if (instance_blackrock_spire::instance_blackrock_spireAI* pInstance = (instance_blackrock_spire::instance_blackrock_spireAI*)pGo->GetInstanceData())
