...
class npc_clintar_dw_spirit : public CreatureScript
{
public:
    npc_clintar_dw_spirit() : CreatureScript("npc_clintar_dw_spirit") { }

    bool OnEffectDummy(Unit* pCaster, uint32 spellId, SpellEffectIndex effIndex, Creature* pCreatureTarget, ObjectGuid /*originalCasterGuid*/) override
    {
...
## go_omen_cluster
######*/
class go_omen_cluster : public GameObjectScript
{
public:
    go_omen_cluster() : GameObjectScript("go_omen_cluster") { }
