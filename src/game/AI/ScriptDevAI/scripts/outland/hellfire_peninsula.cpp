...
{
public:
    npc_danath_trollbane() : CreatureScript("npc_danath_trollbane") { }

    bool OnQuestReward(Player* pPlayer, Creature* pCreature, const Quest* pQuest) override
    {
...
{
public:
    npc_nazgrel() : CreatureScript("npc_nazgrel") { }
...
class npc_krun : public CreatureScript
{
public:
    npc_krun() : CreatureScript("npc_krun") { }
...
###############
*/
class npc_maghar_escort : public CreatureScript
{
public:
    npc_maghar_escort() : CreatureScript("npc_maghar_escort") { }
