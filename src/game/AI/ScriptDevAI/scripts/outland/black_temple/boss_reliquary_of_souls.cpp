...
class npc_reliquary_LOS_aggro_trigger : public CreatureScript
{
public:
    npc_reliquary_LOS_aggro_trigger() : CreatureScript("npc_reliquary_LOS_aggro_trigger") { }
...
class npc_reliquary_combat_trigger : public CreatureScript
{
public:
    npc_reliquary_combat_trigger() : CreatureScript("npc_reliquary_combat_trigger") { }
...
void AddSC_boss_reliquary_of_souls()
{
    ...
    new npc_reliquary_LOS_aggro_trigger();
    new npc_reliquary_combat_trigger();
