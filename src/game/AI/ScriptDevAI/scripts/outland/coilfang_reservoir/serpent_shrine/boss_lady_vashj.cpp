...
class go_shield_generator : public GameObjectScript
{
public:
...
public:
    ...
    bool OnItemLoot(Player* player, Item* /*item*/, bool apply) override
    {
        if (apply)
...
class go_vashj_bridge : public GameObjectScript
{
public:
    go_vashj_bridge() : GameObjectScript("go_vashj_bridge") { }
